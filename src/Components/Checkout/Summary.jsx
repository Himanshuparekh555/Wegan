        ...
        <>
            <Box sx={{border:'1px solid #F2F2F2',borderRadius:12,}} padding={{xs:2,md:3,lg:3.5}}>
                <Grid container sx={{mb:2}}>
                    <Grid item xs={12} sm={3} md={4} display={{xs:'flex',md:'flex',}} justifyContent={{xs:'center',md:'start',lg:'start'}}>
                        <Link href="/shopping-cart"sx={{display:'flex',alignItems:'center', background:'#FAFAFA',borderRadius:6,width:130,height:130}}><img className="w-100" src={ProductImage} alt=""/></Link>
                    </Grid>
                    <Grid item xs={12} sm={9} md={8} sx={{ display:"flex",alignItems:"center",justifyContent:"space-between"}} marginTop={{xs:2,lg:0}}>
                ...
                <Grid container sx={{mb:2}}>
                    <Grid item xs={12} sm={3} md={4} display={{xs:'flex',md:'block',}} justifyContent={{xs:'center'}}>
                        <Link href="/shopping-cart"sx={{display:'flex',alignItems:'center', background:'#FAFAFA',borderRadius:6,width:130,height:130}}><img className="w-100" src={ProductImage} alt=""/></Link>
                    </Grid>
                    <Grid item xs={12} sm={9} md={8} sx={{ display:"flex",alignItems:"center",justifyContent:"space-between"}} marginTop={{xs:2,lg:0}}>
