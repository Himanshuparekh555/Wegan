          ...
          >
            ...
            >
              <Box
                ...
                marginRight={{ xs: 0, md: 3, lg: 3 }}
              >
                <img
                  onClick={navigateToProductDetail}
                  className="cursor-p w-100"
                  src={ProductImage}
                  alt=""
                />
              </Box>
          ...
          <Grid item xs={12} sm={12} md={4}>
            ...
            >
              ...
              >
                ...
                >
                  <Button disableRipple onClick={decNum}>
                  ...
                  <TextField
                    ...
                    id="outlined-basic"
                  />
                  <Button sx={{ background: 0 }} disableRipple onClick={incNum}>
              ...
              >
                ...
                <Typography
                  variant="h5"
                  gutterBottom
                  sx={{ fontSize: 20, fontWeight: 600, textAlign: "right" }}
                >
                  {"$97"}
                </Typography>
              </Grid>
        ...
        >
          ...
          >
            <Button
              ...
              type="submit"
              className="btn-theme"
              sx={{ pt: 1.5, pb: 1.5, pl: 7, pr: 7, borderRadius: 10 }}
            >
              {"Continue"}
            </Button>
          </Grid>
