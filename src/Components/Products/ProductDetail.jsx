      ...
      <Box className="product_detail" sx={{ mt: 8, mb: 4 }}>
        <Container>
                ...
                <Box key={index}>
                  ...
                  >
                    <Grid item xs={12} sm={7} md={7}>
                      <Typography>{data.sku}</Typography>
                    </Grid>
                    <Grid
                      item
                      xs={12}
                ...
                >
                  <Box className="favorite">
                    <Checkbox
                      ...
                      checkedIcon={<FavoriteIcon sx={{ fontSize: 20 }} />}
                    />
                  </Box>
                </Grid>
              </Grid>
          ...
          <Grid
            container
            spacing={5}
            sx={{ display: "flex", alignItems: "center", mt: 8, mb: 8 }}
          >
            ...
            <Grid item xs={12} sm={6} md={6}>
              ...
              >
                <ListItem>
                  ...
                  <ListItemText
                    primary="Natural"
                    secondary="We are natural ingredients only when creating our products"
                  />
                </ListItem>
                <ListItem>
                  <ListItemAvatar>
