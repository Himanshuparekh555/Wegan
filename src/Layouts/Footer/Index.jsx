    ...
    return (
        ...
        <footer>
            <Box className="links" paddingTop={{xs:'30px',md:'50px',lg:'80px'}} sx={{ pb:3}}>
                <Container>
                    <MenuList>
                        <MenuItem disableRipple sx={{ pl:4,pr:4,fontSize:18,}}><NavLink to="/">{"Home"}</NavLink></MenuItem>
                        <MenuItem disableRipple sx={{ pl:4,pr:4,fontSize:18}}><NavLink to="/allproducts">{"Shop"}</NavLink></MenuItem>
                        <MenuItem disableRipple sx={{ pl:4,pr:4,fontSize:18}}><NavLink to="/all-category">{"Category"}</NavLink></MenuItem>
                        <MenuItem disableRipple sx={{ pl:4,pr:4,fontSize:18}}><NavLink to="/blog">{"Blog"}</NavLink></MenuItem>
                        <MenuItem disableRipple sx={{ pl:4,pr:4,fontSize:18}}><Link onClick={toggle} className={isActive ? 'select': null} >{"Contact"}</Link></MenuItem>
                    </MenuList>
                </Container>
            </Box>
            {isOpened && (
                <Box className="footer_middle" sx={{ pt:5,pb:5}}>
                    <Container>
                        <Grid container sx={{ display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                            <Grid item xs={12} sm={12} md={3} textAlign={{xs:'center',md:'center',lg:'left'}}>
                                <LogoIcon/>                            
                            </Grid>
                            <Grid className="footer_info" item xs={12} sm={12} md={8}>
                                <MenuList>
                                    <MenuItem className={showtab===1 ? 'active' : ''} onClick={()=> handletab(1)} sx={{ display:"flex",alignItems:"center",justifyContent:"center",flexDirection:'column'}}>
                                        <LocationIcon/>
                                        <Typography className='title' variant="h6" sx={{ mt:1,mb:1}}>
                                            {"Address"}
                                        </Typography> 
                                        <Typography className='subtitle' variant="body2" gutterBottom sx={{ mb:0}}>
                                    ...
                                    <MenuItem className={showtab===2 ? 'active' : ''} onClick={()=> handletab(2)} sx={{ display:"flex",alignItems:"center",justifyContent:"center",flexDirection:'column'}}>
                                    <MailIcon/>
                                    <Typography className='title' variant="h6" sx={{ mt:1,mb:1}}>
                                        {"Mail"}
                                    </Typography> 
                        ...
                        <Box className={showtab===1 ? 'footer_info_details active' : 'footer_info_details'} sx={{ mt:5}}>
                                <Grid container spacing={6} sx={{ display:"flex",alignItems:"center",}}>
                                    <Grid item xs={12} sm={12} md={4}>
                                        <Typography className='title' variant="h6" sx={{ mb:2}}>
                                            {"All About Us"}
                                        </Typography> 
                                        <Typography className='subtitle' variant="body2" gutterBottom sx={{ mb:4}}>
                        ...
                        <Box className={showtab===2 ? 'footer_info_details active' : 'footer_info_details'}  sx={{ mt:5}}>
                                <Grid container spacing={6} sx={{ display:"flex",alignItems:"center",}}>
                                    ...
                                    <Grid item xs={12} sm={12} md={7}>
                                        <Grid container spacing={3}>
                                            ...
                                            <Grid item xs={12} sm={12} md={6}>                                            
                                                <TextField multiline rows={3} fullWidth placeholder="Type your query…" variant="outlined" />
                                            </Grid>
                                            <Grid item xs={12} justifyContent={{xs:'center',md:'start',lg:'start'}} sx={{ display:"flex",}}>                                            
                                                <Button sx={{ borderRadius:10,pl:5,pr:5}} className="btn-theme" variant="contained">{"Send"}</Button>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                            </Grid>
            ...
            <Box sx={{ pt:3,pb:3}}>
                <Typography className='subtitle' variant="body2" gutterBottom sx={{ mb:0}}>
                    <Container>
                        <Typography className='subtitle' variant="body2" gutterBottom sx={{ mb:0,color:'#8E8E93'}}>
